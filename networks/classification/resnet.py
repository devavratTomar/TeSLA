...
model_dict = {
    'resnet50_s': [resnet50, 2048],
    'resnet50': [models.__dict__["resnet50"], 2048],
    'resnet101': [models.__dict__["resnet101"], 2048],
}


class AdaptSupCEResNet(nn.Module):
    def __init__(self, name='resnet50', num_classes=10):
        super(AdaptSupCEResNet, self).__init__()
        model_fn, self.dim = model_dict[name]
        ...
        if name == 'resnet50_s':
            ...
            self.fc = copy.deepcopy(self.encoder.fc)
