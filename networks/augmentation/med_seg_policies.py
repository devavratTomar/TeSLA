...
import torch
import math
from networks.augmentation.img_ops.autosegment import Invert, ShearX, ShearY, TranslateX, TranslateY, Rotate, AutoContrast, Equalize, Posterize, Contrast, Brightness, Sharpness
